		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsapsamplevariantsamplevariant-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapsamplevariantsamplevariant-display": {
								"semanticObject": "comsapsamplevariantsamplevariant",
								"action": "display",
								"description": "A Fiori application with sample variant with SmartVaraiantManagement",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.sample.variant.samplevariant",
									"url": sap.ui.require.toUrl("com/sap/sample/variant/samplevariant")
								}
							}
						}
					}
